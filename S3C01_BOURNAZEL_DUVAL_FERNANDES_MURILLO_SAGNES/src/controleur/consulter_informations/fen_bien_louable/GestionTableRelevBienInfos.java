...
public class GestionTableRelevBienInfos implements ListSelectionListener {
	...
	/**
	 * Initialise la classe de gestion de la table des relevés de compteurs d'un
	 * bien
	 * 
	 * @param fenetreTable fenetre contenant la table
	 */
	public GestionTableRelevBienInfos(FenBienLouableInformations fenetreTable) {
	...
	/**
	 * Remet à 0 la table et la re-remplit
	 * 
	...
	public void ecrireLigneTable(String idbien) {
		...
		try {
			...
			tableauReleve = (List<ReleveCompteur>) daoReleve.findAllByIdBien(idbien);
