...
/**
 * Sous programme permettant de retourner le total des montants d'enlèvement
 * d'ordures d'un batiment d'id spécifié sur une année spécifiée
 */
public class SousProgrammeTotalOrduresBatimentSurAnnee implements SousProgramme<Float> {

	@Override
	public String appelSousProgramme() {
		return "{? = call  Total_ordures_Batiment_sur_Annee(?,?)}";
	}
