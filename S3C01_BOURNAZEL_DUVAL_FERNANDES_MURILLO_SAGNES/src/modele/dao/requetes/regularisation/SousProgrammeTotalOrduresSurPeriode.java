...
/**
 * Sous programme permettant de retourner le total (montant) de la taxe
 * d'ordures ménagères concernant un bien d'ID donné et sur une période d'une
 * date de début donnée à une date de fin donnée
 */
public class SousProgrammeTotalOrduresSurPeriode implements SousProgramme<Float> {

	@Override
	public String appelSousProgramme() {
		return "{? = call TOTAL_ORDURES_SUR_PERIODE(?,?,?)}";
	}
