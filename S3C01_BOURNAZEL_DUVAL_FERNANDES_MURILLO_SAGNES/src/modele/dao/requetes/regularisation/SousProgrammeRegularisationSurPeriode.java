...
/**
 * Sous programme permettant de retourner le total (montant) de la
 * régularisation des charges concernant un bien d'ID donné et sur une période
 * d'une date de début donnée à une date de fin donnée
 */
public class SousProgrammeRegularisationSurPeriode implements SousProgramme<Float> {

	@Override
	public String appelSousProgramme() {
		return "{? = call REGULARISATION_DES_CHARGES(?,?,?)}";
	}
