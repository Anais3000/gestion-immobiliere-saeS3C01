...
/**
 * Sous programme permettant de retourner le total (montant) des provisions pour
 * charge versées concernant un bien d'ID donné et sur une période d'une date de
 * début donnée à une date de fin donnée
 */
public class SousProgrammeTotalProvisionsSurPeriode implements SousProgramme<Float> {

	@Override
	public String appelSousProgramme() {
		return "{? = call TOTAL_PROVISIONS_SUR_PERIODE(?,?,?)}";
	}
