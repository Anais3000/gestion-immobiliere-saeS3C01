...
/**
 * Sous programme permettant de retourner le total des provisions pour charges
 * percues par un bien louable d'id spécifié sur une année spécifiée
 */
public class SousProgrammeTotalProvisionsPercuesParBienEtAnnee implements SousProgramme<Float> {

	@Override
	public String appelSousProgramme() {
		// bien (String) puis année (int)
		return "{? = call Total_provisions_percus_bien_annee(?,?)}";
	}
